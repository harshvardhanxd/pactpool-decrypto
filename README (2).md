...
📚 Education · ✈️ Travel · 💼 Business · 💻 Gadget · 🏃 Health · 🏠 Home · 📈 Invest · ⭐ Other
...
| Role | Responsibility |
|------|---------------|
| P1 | Smart Contract — Solidity, Remix, Etherscan verification |
| P2 | Frontend — Deposit UI, wallet connect, active pact card |
| P3 | Frontend — Goal Wall, Simulator tab, ticker |
| P4 | Integration — ABI wiring, GitHub Pages deployment, demo prep |
